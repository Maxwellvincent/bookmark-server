...
describe('Bookmarks Endpoints', () => {
    ...
    // Before we start test we want to make a connection to the database. We need a knexInstance to do this.
    before('make a knex instance', () => {
        ...
        // Were making an knexInstance available within app.js
        app.set('db', db);
    })

    after('disconnect from db', () => db.destroy());

    before('cleanup the table, by removing rows', () => db('bookmarks').truncate())
